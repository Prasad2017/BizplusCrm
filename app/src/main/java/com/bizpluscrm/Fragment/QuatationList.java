...
public class QuatationList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_quatation_list, container, false);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.addEnquiry:
                ((MainPage) getActivity()).loadFragment(new AddQuatation(), true);
                break;
