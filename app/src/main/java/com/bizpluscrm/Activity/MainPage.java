...
import com.bizpluscrm.Fragment.EnquiryList;
import com.bizpluscrm.Fragment.Home;
import com.bizpluscrm.Fragment.QuatationList;
import com.bizpluscrm.Fragment.QuatationList_ViewBinding;
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.enquiry:
                        loadFragment(new EnquiryList(), false);
                        return true;

                    case R.id.quotation:
                        loadFragment(new QuatationList(), false);
                        return true;
